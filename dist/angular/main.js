...
class AdminService {
    constructor(http) {
        ...
        this.avail = false;
        this.msg = "";
        this.baseUri = "https://backendapp-39804.web.app/admin";
...
class AddpizzaComponent {
    ...
    onSubmit(f) {
        ...
        this.http.post('https://backendapp-39804.web.app/admin/addpizza', formData).subscribe((res) => {
...
ViewpizzaComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ViewpizzaComponent, selectors: [["app-viewpizza"]], decls: 22, vars: 1, consts: [["lang", "en"], ["charset", "utf-8"], ["name", "viewport", "content", "width=device-width, initial-scale=1, shrink-to-fit=no"], ["rel", "stylesheet", "href", "https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css", "integrity", "sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk", "crossorigin", "anonymous"], [1, "table", "table-hover", "w-50", 2, "background-color", "white", "box-shadow", "0px 0px 19px 5px rgba(0, 0, 0, 0.5)"], ["scope", "col"], [4, "ngFor", "ngForOf"], ["scope", "row"], ["alt", "", "height", "100", "width", "100", 3, "src"], ["href", "#", 1, "btn", "btn-link", 3, "click"], ["aria-hidden", "true", 1, "fas", "fa-edit"], [1, "btn", "btn-link", 3, "click"], ["aria-hidden", "true", 1, "fa", "fa-trash"]], template: function ViewpizzaComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", ctx.pizza);
...
class CartService {
    constructor(http, router) {
        ...
        this.avail = false;
        this.msg = "";
        this.baseUri = "https://backendapp-39804.web.app";
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Content-Type', 'application/json');
    }
    addPizza(body) {
        return this.http.post('https://backendapp-39804.web.app/addtocart', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
    deletePizza(body) {
        return this.http.post('https://backendapp-39804.web.app/deletefromcart', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
...
class EditpizzaComponent {
    ...
    onSubmit(f) {
        ...
        if (f.controls.pizzapic.value) {
            ...
            formData.append('file', this.image);
            // *************
            this.http.post('https://backendapp-39804.web.app/admin/editpizzawithimage', formData).subscribe((res) => {
                this.adminService.avail = true;
            ...
            this.http.get('https://backendapp-39804.web.app/admin/editpizzawithoutimage?id=' + this.id + '&pizzaname=' + this.pn + '&pizzasize=' + this.ps + '&pizzaprice=' + this.pp).subscribe((res) => {
                this.adminService.avail = true;
                this.adminService.msg = "Successfully Edited a pizza!!!";
                this.router.navigate(['/admin']);
                console.log(res);
...
class AuthService {
    ...
    register(body) {
        return this.http.post('https://backendapp-39804.web.app/register', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
    ...
    reset(body) {
        return this.http.post('https://backendapp-39804.web.app/reset', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
    resetpassworddone(body) {
        return this.http.put('https://backendapp-39804.web.app/forgot-password-done', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
    ...
    login(body) {
        return this.http.post('https://backendapp-39804.web.app/login', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
    ...
    changepassword(body) {
        return this.http.post('https://backendapp-39804.web.app/changepassword', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
    sendfeedback(body) {
        return this.http.post('https://backendapp-39804.web.app/sendfeedback', body, {
            observe: 'body',
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().append('Content-Type', 'application/json')
        });
    }
